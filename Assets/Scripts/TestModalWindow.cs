...
//      modalPanel.Choice ("Would you like a poke in the eye?\nHow about with a sharp stick?", myYesAction, myNoAction, myCancelAction);
    ...
    {
        Debug.Log("YES and No");
        modalPanel.Choice("This question only test Yes and No Button!", myYesAction, myNoAction);
    }
    
    public void TestOnlyYes()
    {
        Debug.Log("Only Yes");
        modalPanel.Choice("This question only test Yes Button!", myYesAction);
    }
